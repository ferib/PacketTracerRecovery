...
namespace BadTime
{
    class Program
    {
        ...
        //41 ?? 01 00 00 00 44 89 ?? 24 ?? 41 83 ?? FF 4C ?? ?? 8B ??
        ...
        private static void InjectAssembly(Process process)
        {
            ...
            byte[] PWoverwrite = new byte[]
            {
                ...
                0x48, 0xB8, 0xDE, 0xAD, 0xC0, 0xDE, 0xDE, 0xC0, 0xAD, 0xDE,                                        //mov rcx, Alloc+2 (+69)
                0x50,   //push rax // TOOD: use RAX ptr instead!!
                0x51,   //push rcx 
                0x48, 0x83, 0xC2, 0x18, // TOOD: remove
                0x48, 0x8B, 0x08,
                0x48, 0x89, 0x0A,
                0x48, 0x8B, 0x48, 0x08, //Some MOV's... cba putting time into it, 
                0x48, 0x89, 0x4A, 0x08, //it's stable and it works, moste of you can't read it anyways
                0x48, 0x8B, 0x48, 0x10,
                0x48, 0x89, 0x4A, 0x10,
                0x48, 0x8B, 0x48, 0x18,
                0x48, 0x89, 0x4A, 0x18,
                ...
                0x48, 0x8B, 0x48, 0x38,
                0x48, 0x89, 0x4A, 0x38,
                0x48, 0x83, 0xEA, 0x18, // TOOD: remove
                0x59,   //pop rcx
                0x58    //pop rax
            };
            #endregion
